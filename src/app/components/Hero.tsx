          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="/blog"
                  className="border-2 border-gray-300 dark:border-gray-700 text-black dark:text-white px-8 py-4 rounded-xl font-semibold text-center hover:bg-gray-50 dark:hover:bg-gray-900 transition-all duration-200"
                >
                  See Examples
                </Link>
              </div>
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <div className="absolute -inset-4 bg-gray-200 dark:bg-gray-800 rounded-3xl opacity-30 blur-3xl"></div>
