...
export default function MyProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 pt-10">
      ...
      <div className="relative flex flex-col md:flex-row justify-center -mt-12 mb-10 gap-6">
        <ProfileImage
        ...
        <div className="md:pt-4">
          {isEditing ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 border rounded-full hover:bg-gray-50 transition-all text-sm font-medium"
            >
              <Edit3 size={16} />
              Edit Profile
            </button>
      ...
      <div className="border-t pt-8">
        ...
        {activeTab === "followers" && (
          <div>
            <h2 className="text-xl font-bold mb-6">Your Followers</h2>
            {profile.followers && profile.followers.length > 0 ? (
              ...
              <div className="text-gray-400 italic py-10 border-2 border-dashed rounded-xl text-center">
                No followers yet. Share your stories to get followers!
              </div>
            )}
          </div>
        )}
        ...
        {activeTab === "following" && (
          <div>
            <h2 className="text-xl font-bold mb-6">Users You Follow</h2>
            {profile.following && profile.following.length > 0 ? (
              ...
              <div className="text-gray-400 italic py-10 border-2 border-dashed rounded-xl text-center">
                You haven't followed anyone yet. Explore stories to find authors
                to follow!
              </div>
            )}
          </div>
